...
#am__append_2 = -DVGABI_
##am__append_3 = -DVGABI_
#am__append_4 = -Wl,-M,$(top_srcdir)/solaris/vgpreload-solaris.mapfile
...
ACLOCAL = ${SHELL} /home/yong/newdisk/test/valgrind-3.14.0/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = /home/yong/newdisk/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar
AUTOCONF = ${SHELL} /home/yong/newdisk/test/valgrind-3.14.0/missing autoconf
AUTOHEADER = ${SHELL} /home/yong/newdisk/test/valgrind-3.14.0/missing autoheader
AUTOMAKE = ${SHELL} /home/yong/newdisk/test/valgrind-3.14.0/missing automake-1.15
AWK = gawk
BOOST_CFLAGS = 
BOOST_LIBS = 
CC = /home/yong/newdisk/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc -std=gnu99
CCAS = /home/yong/newdisk/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
CCASDEPMODE = depmode=gcc3
CCASFLAGS = --sysroot=/home/yong/newdisk/android-ndk/platforms/android-21/arch-arm
CCDEPMODE = depmode=gcc3
CFLAGS = --sysroot=/home/yong/newdisk/android-ndk/platforms/android-21/arch-arm
CFLAGS_MPI = -g -O -fno-omit-frame-pointer -Wall -fpic
CPP = /home/yong/newdisk/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc -E
CPPFLAGS = --sysroot=/home/yong/newdisk/android-ndk/platforms/android-21/arch-arm -DANDROID_HARDWARE_generic -DVGPV_arm64_linux_android=1
CXX = g++
...
LTO_AR = /home/yong/newdisk/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar
LTO_CFLAGS = 
LTO_RANLIB = /home/yong/newdisk/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ranlib
MAINT = #
MAKEINFO = ${SHELL} /home/yong/newdisk/test/valgrind-3.14.0/missing makeinfo
MKDIR_P = /bin/mkdir -p
MPI_CC = mpicc
OBJEXT = o
PACKAGE = valgrind
...
PACKAGE_STRING = Valgrind 3.14.0
...
RANLIB = /home/yong/newdisk/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/sh
SOLARIS_UNDEF_LARGESOURCE = 
STRIP = /home/yong/newdisk/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-strip
...
VG_TMPDIR = /sdcard
abs_builddir = /home/yong/newdisk/test/valgrind-3.14.0
abs_srcdir = /home/yong/newdisk/test/valgrind-3.14.0
abs_top_builddir = /home/yong/newdisk/test/valgrind-3.14.0
abs_top_srcdir = /home/yong/newdisk/test/valgrind-3.14.0
ac_ct_CC = 
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/yong/newdisk/test/valgrind-3.14.0/install-sh
...
AM_CFLAGS_BASE = -O2 -finline-functions -g -Wall -Wmissing-prototypes \
	-Wshadow -Wpointer-arith -Wstrict-prototypes \
	-Wmissing-declarations  -Wcast-qual \
	-Wwrite-strings -Wempty-body -Wformat \
	 -Wformat-security \
	-Wignored-qualifiers -Wmissing-parameter-type \
	-Wlogical-op -Wold-style-declaration \
	-fno-stack-protector  \
...
AM_CPPFLAGS_ARM_LINUX = -I$(top_srcdir) \
...
PRELOAD_LDFLAGS_COMMON_SOLARIS = -nodefaultlibs -shared \
	-Wl,-z,interpose,-z,initfirst $(am__append_4)
...
DEFAULT_SUPP_FILES = exp-sgcheck.supp xfree-3.supp xfree-4.supp bionic.supp 
